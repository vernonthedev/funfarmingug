...
import { Input, type InputProps } from '@/admin/components/ui/input';
import { Textarea, type TextareaProps } from '@/admin/components/ui/textarea';
...
export function InputGroup({
    ...
    return (
        // biome-ignore lint/a11y/useSemanticElements: composite input group container; role="group" is intentional
        <div
            className={cn(
...
export function InputGroupAddon({
    ...
    return (
        // biome-ignore lint/a11y/noStaticElementInteractions: addon forwards focus to adjacent input; input is keyboard-accessible
        <div
