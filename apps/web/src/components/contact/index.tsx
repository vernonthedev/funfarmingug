                    ...
                    <div className="row">
                        <div className="col-lg-6">
                            <div className="wg-contact">
                                <div className="heading-section style-4 mb-24">
                                ...
                                <p className="text mb-30">
                                    ...
                                    activities or our approach? Call, email us
                                    or check the frequently asked questions.
                                </p>
                                <ul className="contact-list style-3">
                                    <li
                        ...
                        <div className="col-lg-6">
                            <div className="box-contact-form">
                                ...
                                <form
                                    ...
                                    method="post"
                                    action="#"
                                    className="form-send-message style-3"
                                >
