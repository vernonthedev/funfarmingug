...
export default function BlogRightPage() {
    const description =
        blogPost.content.replace(/<[^>]*>/g, '').substring(0, 200) + '...';
    return (
        <>
            <HeroSection
                subtitle="Blog"
                            ...
                            <aside className="blog-sidebar">
                                ...
                                <div className="sidebar-widget category-widget">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#">
                                                Gardening Tips <span>(12)</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                Organic Methods <span>(8)</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                Soil Health <span>(6)</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                Urban Farming <span>(10)</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                Pest Management <span>(5)</span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                                <div className="sidebar-widget recent-posts">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#">
                                                Composting 101: Turn Waste into
                                                Gold
                                            </a>
                            ...
                            <article className="blog-single">
                                ...
                                <div className="blog-single-author">
                                    ...
                                    <div className="author-info">
                                        ...
                                        <p>
                                            Organic farming specialist with 15
