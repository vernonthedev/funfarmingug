...
export default function Index7Page() {
    return (
        <>
            ...
            />
            <TeamSection subtitle="Instructors" title="Expert Educators" />
            <ProjectsSection
                subtitle="Demo Gardens"
                title="Living Classrooms"
            />
            <TestimonialsSection subtitle="Students" title="Learning Success" />
            <ProductsSection
                subtitle="Learning Kits"
                title="Garden Education Tools"
            />
            <FAQSection subtitle="Education FAQ" title="Course Questions" />
        </>
    );
}
