...
const serviceDetail = {
    ...
    description:
        "We believe that growing food should be natural, beautiful, & part of everyday life. That's why our services cover everything from soil testing to custom compost blends.",
    features: [
