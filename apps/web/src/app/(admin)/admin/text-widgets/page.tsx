...
import { textWidgets } from '@/admin/lib/site-content';

export default function TextWidgetsPage() {
    return (
        <div className="space-y-6">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Button render={<Link href="/admin/text-widgets/new" />}>
                    ...
                    <TableBody>
                        {textWidgets.map((widget) => (
                            ...
                            >
                                ...
                                <TableCell>
                                    <Link
                                        href={`/admin/text-widgets/${widget.id}`}
