...
const serviceDetail = {
  ...
  description: 'Living in the city doesn\'t mean giving up on green dreams. Orgaanic specializes in urban agriculture solutions that turn balconies, rooftops, and small yards into productive gardens.',
  features: [
          ...
          <div className="row">
            ...
            <div className="col-xl-8 col-lg-8 mx-auto">
              <div className="service-single-info text-center">
                ...
                <div className="space30"></div>
                <a href="/contact" className="btn-home6">Order This Service</a>
              </div>
            </div>
          </div>
        </div>
