                    ...
                    <div className="row">
                        <div className="col-xl-6 col-lg-6">
                            <div className="contact-info">
                                ...
                                <p>
                                    We're here to help you grow. Whether you
                                    have a question about our services, want to
                                    start a project, or just want to say hello.
                                </p>
                                ...
                                <div className="contact-info-items">
                                    ...
                                    <div className="contact-item">
                                        <div className="contact-icon">
                                            <img
                                                src="/assets/img/icon/contact-icon(2).svg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="contact-content">
                                    ...
                                    <div className="contact-item">
                                        <div className="contact-icon">
                                            <img
                                                src="/assets/img/icon/contact-icon(3).svg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="contact-content">
