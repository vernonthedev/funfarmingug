...
const serviceDetail = {
    ...
    description:
        'At Orgaanic, we empower you to turn unused corners of your home into thriving green spaces. Our expert-guided services cover everything from initial consultation to ongoing plant care and growth monitoring.',
    features: [
