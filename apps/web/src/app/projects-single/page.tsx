...
const projectDetail = {
    ...
    description:
        'This flagship project transformed an unused concrete lot into a thriving community farm. The project demonstrates the power of regenerative agriculture to heal land and build community.',
    details: [
                                    ...
                                    {gallery.map((img, i) => (
                                        <div key={i} className="col-md-3">
                                            <div className="gallery-item image-anime">
                                                <img
                                                    src={img}
                                                    alt={`${projectDetail.title} - Gallery ${i + 1}`}
                                                />
                                            </div>
                                        </div>
                                    ))}
