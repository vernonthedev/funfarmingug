        ...
        <div className="row">
            ...
            <div className="row align-items-center">
              <div className="col-xl-3 col-lg-3 col-md-6">
                <div className="footer1-mobile">
                  <div className="icons">
                    <a href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M13.6177 21.367C13.1841 21.773 12.6044 22 12.0011 22C11.3978 22 10.8182 21.773 10.3845 21.367C6.41302 17.626 1.09076 13.4469 3.68627 7.37966C5.08963 4.09916 8.45834 2 12.0011 2C15.5439 2 18.9126 4.09916 20.316 7.37966C22.9082 13.4393 17.599 17.6389 13.6177 21.367Z" stroke="white" strokeWidth="1.5"></path>
                        <path d="M15.5 11C15.5 12.933 13.933 14.5 12 14.5C10.067 14.5 8.5 12.933 8.5 11C8.5 9.067 10.067 7.5 12 7.5C13.933 7.5 15.5 9.067 15.5 11Z" stroke="white" strokeWidth="1.5"></path>
                      </svg>
                      Location
                    </a>
                  </div>
                  ...
                  <ul>
                    <li><a href="#">Charabari, Shingra, Natore,</a></li>
                    <li><a href="#">Rajshahi Division, Bangladesh</a></li>
                  </ul>
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6">
                <div className="footer1-mobile">
                  <div className="icons">
                    <a href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M2 5L8.91302 8.92462C11.4387 10.3585 12.5613 10.3585 15.087 8.92462L22 5" stroke="white" strokeWidth="1.5" strokeLinejoin="round"></path>
                  ...
                  <div className="space24"></div>
                  <ul>
                    <li><a href="mailto:info@orgaanicfarm.com">info@orgaanicfarm.com</a></li>
                    <li><a href="mailto:support@orgaanicfarm.com">support@orgaanicfarm.com</a></li>
                  </ul>
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6">
                <div className="footer1-mobile lg-mt20">
                  ...
                  <div className="space24"></div>
                  <ul>
                    <li><a href="tel:+8801712345678">+880 1712345678</a></li>
                    <li><a href="tel:+8801798743210">+880 1798743210</a></li>
                  </ul>
                </div>
              </div>
              <div className="col-xl-3 col-lg-3 col-md-6">
                <div className="footer1-mobile footer1-mobile-fixxer lg-mt20">
                  <Link href="/contact" className="btn4-home6">Contact Us</Link>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="row">
              ...
              <div className="col-xl-4 col-lg-4 col-md-6">
                <div className="footer1-logo-area">
                  <img src="/assets/img/footer/footer1-logo.png" alt="Orgaanic Logo" />
                  <div className="space24"></div>
                  <p>We're committed to delivering fresh, chemical-free dairy and meat products straight from our pasture to your plate. Our mission is to raise healthy cattle</p>
                  <div className="space28"></div>
                  <div className="footer1-subscribe">
                    <form action="#">
                      <input type="email" placeholder="Email" />
                      <div className="sub-btn">
                        <button type="submit" className="btn4-home6">Subscribe</button>
                      </div>
                    </form>
                  </div>
                </div>
              ...
              <div className="col-xl-2 col-lg-4 col-md-6">
                <div className="footer-widget-area wid1-fix mt-20xs_brk">
                  ...
                  <ul>
                    ...
                    <li><Link href="/about-us">Our Farm</Link></li>
                    <li><Link href="/about-us">About Us</Link></li>
                    <li><Link href="/service">Our Service</Link></li>
                    <li><Link href="/blog">Contact Us</Link></li>
              ...
              <div className="col-xl-2 col-lg-4 col-md-6">
                <div className="footer-widget-area">
                  ...
                  <div className="space28"></div>
                  <ul>
                    <li><Link href="/service">Fresh Organic Milk</Link></li>
                    <li><Link href="/service">Artisanal Farm Cheese</Link></li>
                    <li><Link href="/service">Grass-Fed Beef Supply</Link></li>
                    <li><Link href="/service">Natural Yogurt & Curd</Link></li>
                    <li><Link href="/service">Artisanal Farm Cheese</Link></li>
                    <li><Link href="/service">Organic Feed Supply</Link></li>
                  </ul>
                </div>
              </div>
              ...
              <div className="col-xl-4 col-lg-4 col-md-6">
                <div className="footer1-widget-hour-info">
                  <div className="footer-widget-hour">
                    ...
                    <div className="space28"></div>
                    <ul>
                      <li><span><a className="f-date" href="#">Mon–Fri:</a></span> <span><a href="#">8:00 AM - 6:00 PM</a></span></li>
                      <li><span><a className="f-date" href="#">Sunday :</a></span> <span><a href="#">2:00 AM - 9:00 PM</a></span></li>
                      <li><span><a className="f-date" href="#">Saturday :</a></span> <span><a href="#">Closed</a></span></li>
                    </ul>
                  </div>
                  <div className="space28"></div>
          ...
          <div className="footer1-copyright-area">
            <ul className="footer1-copyright-wrap">
              <li><a href="#">© Orgaanic 2026. All Rights Reserved.</a></li>
              <li><a className="fw-500" href="#">Built with care <span>|</span> Powered by nature</a></li>
            </ul>
          </div>
        </div>
      </div>
