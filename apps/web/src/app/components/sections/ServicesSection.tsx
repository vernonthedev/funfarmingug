...
const defaultServices: ServiceItem[] = [
    {
        ...
        description:
            'At Orgaanic, we empower you to turn unused corners of your home into thriving green spaces. Our expert-guided services',
        linkText: 'Learn More',
        linkHref: '/contact',
        stepNumber: '01',
    },
    {
        ...
        description:
            "We believe that growing food should be natural, beautiful, & part of everyday life. That's why our services cover everything",
        linkText: 'Learn More',
        linkHref: '/contact',
        stepNumber: '02',
    },
    {
        ...
        description:
            "Living in the city doesn't mean giving up on green dreams. Orgaanic specializes in urban agriculture solutions that turn",
        linkText: 'Learn More',
        linkHref: '/contact',
        stepNumber: '03',
    },
