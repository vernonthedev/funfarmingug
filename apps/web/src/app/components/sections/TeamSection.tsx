      ...
      <div className="container">
        <div className="row">
          <div className="team6-heading">
            <div className="service6-top">
              ...
              <div className="service6-top-right">
                <p className="text" data-aos="fade-left" data-aos-duration="1000">{description}</p>
              </div>
            </div>
          </div>
          <div className="space44"></div>
          
          <div className="swiper myteam6" data-aos="zoom-out" data-aos-duration="1000">
                          ...
                          {member.socialLinks?.map((social, i) => (
                            <li key={i}>
                              <a href={social.href} aria-label={social.platform}>
                                <i className={socialIcons[social.platform] || 'fa-brands fa-facebook'}></i>
                              </a>
                            </li>
                          ))}
                        </ul>
          ...
          <div className="team6-arrow">
            <div className="next-arrow mr-12" data-aos="fade-right" data-aos-duration="900">
              <a href="#"><img src="/assets/img/icon/arrow-left-testi06.svg" alt="" /></a>
            </div>
            <div className="prev-arrow" data-aos="fade-left" data-aos-duration="900">
              <a href="#"><img src="/assets/img/icon/arrow-right-testi06.svg" alt="" /></a>
            </div>
          </div>
        </div>
      </div>
