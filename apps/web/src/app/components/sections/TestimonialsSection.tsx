      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="swiper mytestimo6" data-aos="zoom-out" data-aos-duration="1000">
                ...
                {testimonials.map((testimonial, index) => (
                  <div key={index} className="swiper-slide">
                    <div className="testimonial6-info">
                      ...
                      <p className="testimonial6-text">{testimonial.text}</p>
                      <div className="space38"></div>
                      <div className="testimonial6-bottom">
                        <div className="testimonial6-user">
                          <h3><Link href="/testimonials">{testimonial.author}</Link></h3>
                          <div className="space16"></div>
