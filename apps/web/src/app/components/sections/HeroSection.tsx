...
const heroContent = {
    default: {
        ...
        description:
            "Welcome to Orgaanic your trusted partner in home-based agriculture. Whether it's a balcony garden or a backyard farm, we make it easy",
...
export default function HeroSection({
    ...
    const bgImage =
        content.backgroundImage || heroContent.default.backgroundImage;

    return (
        <section
            className="vl-hero6-area parallaxie"
            style={{
        ...
        >
            <div className="hero6-bg1">
                            ...
                            <div className="vl-hero6-info">
                                ...
                                <div className="hero6-btn-area">
                                    <Link
                                        ...
                                        className="btn-home6 hero6-btn-fxr"
                                        data-aos="zoom-out"
                                        data-aos-duration="900"
                                    >
                ...
                <div className="hero_bottom_slider">
                    <div className="hero6-bottom-text">
                        <h2>Agriculture</h2>
                    </div>
                    <div className="hero6-bottom-text">
                        <h2>Agriculture</h2>
