...
const defaultFeaturedProjects: ProjectItem[] = [
  {
    ...
    description: 'Every project we take on is a reflection of our mission to bring agriculture back home literally. Whether it\'s a rooftop garden',
    linkHref: '/project',
  },
  {
        ...
        <div className="row">
          <div className="project6-heading">
            <div className="service6-top">
              ...
              <div className="service6-top-right">
                <p className="text-effect" data-aos="fade-left" data-aos-duration="1000">{description}</p>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            {featuredProjects.map((project, index) => (
              <div key={index} className="col-xl-6 col-lg-6 mb-30" data-aos="zoom-out" data-aos-duration={index === 0 ? 900 : 1000}>
                <div className="project6-box">
                  <div className="project6-thumb image-anime">
                    <img className="imgs" src={project.image} alt="" />
                    <div className="project6-thumb-content">
                      ...
                      <h3 className="title"><Link href={project.linkHref || '#'}>{project.title}</Link></h3>
                      <p className="pera-text">{project.description}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="row">
            {projects.map((project, index) => (
              <div key={index} className="col-xl-4 col-lg-6 mb-30" data-aos={index % 2 === 0 ? 'zoom-in' : 'zoom-out'} data-aos-duration={1000}>
                <div className="project6-box">
                  <div className="project6-thumb image-anime">
                    <img className="imgs" src={project.image} alt="" />
                    <div className="project6-thumb-content">
