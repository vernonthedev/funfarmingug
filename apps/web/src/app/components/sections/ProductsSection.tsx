      ...
      <div className="container">
        <div className="row">
          <div className="product6-heading">
            <div className="service6-top">
              <div className="service6-top-left">
                <h3 className="product6-subtitle" data-aos="fade-right" data-aos-duration="900">{subtitle}</h3>
                <div className="space16"></div>
                <h2 className="clr-white text-anime-style-3" data-aos="fade-left" data-aos-duration="1000">{title}</h2>
              </div>
              <div className="service6-top-right">
                <p className="product6-pera text-effect" data-aos="fade-left" data-aos-duration="900">{description}</p>
                <div className="space24"></div>
                <Link href={buttonHref} className="btn4-home6" data-aos="fade-left" data-aos-duration="1000">{buttonText}</Link>
              </div>
            </div>
          </div>
          <div className="space44"></div>
          
          <div className="swiper myproduct6" data-aos="zoom-out" data-aos-duration="900">
                  ...
                  <div className="product6-box">
                    <div className="product-thumb">
                      ...
                      <div className="product6-line">
                        <img src="/assets/img/shape/product6-line.png" alt="" />
                      </div>
                      <div className="product6-icons">
                        <ul>
                          <li><a href="#"><img src="/assets/img/icon/product6-icons(1).svg" alt="" /></a></li>
                          <li><a href="#"><img src="/assets/img/icon/product6-icons(2).svg" alt="" /></a></li>
                          <li><a href="#"><img src="/assets/img/icon/product6-icons(3).svg" alt="" /></a></li>
                        </ul>
                      </div>
                    </div>
                    <div className="space24"></div>
                    <div className="product6-box-content">
                      <div className="product6-content_text">
                        <h3><Link href={product.linkHref || '#'}>{product.title}</Link></h3>
                      </div>
                      <div className="space16"></div>
                      <div className="product6_info">
                        <div className="product-price">
                          <span className="new-price"><a href={product.linkHref || '#'}>{product.price}</a></span>
                          {product.originalPrice && (
                            <span className="old-price"><a href={product.linkHref || '#'}>{product.originalPrice}</a></span>
                          )}
                        </div>
                        <div className="product_star product6_star">
                          <ul>
                            {Array.from({ length: product.rating || 5 }, (_, i) => (
                              <li key={i}><a href="#"><i className="fa-solid fa-star"></i></a></li>
                            ))}
                          </ul>
                        </div>
                      </div>
          ...
          <div className="product6-arrow">
            <div className="prev-arrow" data-aos="fade-right" data-aos-duration="900">
              <img src="/assets/img/icon/left-arrow-hm6.svg" alt="" />
            </div>
            <div className="next-arrow" data-aos="fade-left" data-aos-duration="900">
