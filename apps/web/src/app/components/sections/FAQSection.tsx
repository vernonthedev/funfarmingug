      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-xl-6 col-lg-6">
            <div className="vl-faq-content-wrap-2 vl-faq6" data-sal="slide-up" data-sal-duration="1000" data-sal-delay="100" data-sal-easing="ease-in-out">
              <div className="vl-faq-accordion">
                <div className="accordion" id="accordionExample">
                  {faqs.map((faq, index) => (
                    <div key={index} className="vl-accordion-item" data-aos="fade-right" data-aos-duration={800 + index * 100}>
                      <h2 className="accordion-header" id={`heading${index + 1}`}>
                        ...
                        >
                          ...
                          <span className="vl-faqarrow vl-faqarrow-2"><i className="fa-solid fa-angle-down"></i></span>
                        </button>
                      </h2>
                      <div
                        id={`collapse${index + 1}`}
