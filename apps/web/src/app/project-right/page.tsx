...
const projectDetail = {
    ...
    description:
        'Transform your small outdoor space into a productive mini farm. This project showcases how even limited space can yield abundant harvests with the right design and techniques.',
    details: [
