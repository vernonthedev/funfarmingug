...
const projectDetail = {
  ...
  description: 'Every project we take on is a reflection of our mission to bring agriculture back home literally. Whether it\'s a rooftop garden in the city or a backyard farm in the suburbs, we approach each project with the same care and expertise.',
  details: [
