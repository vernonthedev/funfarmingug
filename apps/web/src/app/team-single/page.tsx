...
const teamMember = {
  ...
  expertise: ['Organic Farming', 'Sustainable Agriculture', 'Urban Gardening', 'Permaculture Design'],
  socialLinks: [
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="team-single-info">
                ...
                <div className="team-single-expertise">
                  ...
                  <ul>
                    {teamMember.expertise.map((skill, i) => (
                      <li key={i}><i className="fa-solid fa-check"></i> {skill}</li>
                    ))}
                  </ul>
                </div>
              </div>
