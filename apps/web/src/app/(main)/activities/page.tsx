...
export default function ActivitiesPage() {
    const activities = [
        {
            title: 'Board Games',
            description: 'Engage in exciting board games that blend fun with strategy. Perfect for team building and family gatherings.',
            icon: '/assets/img/icon/service6-icon(1).svg',
            number: '01'
        },
        {
            title: 'Farm Kitchen',
            description: 'Experience the taste of Uganda with our farm-to-table kitchen. Enjoy fresh, organic meals prepared with local ingredients.',
            icon: '/assets/img/icon/service6-icon(2).svg',
            number: '02'
        },
        {
            title: 'Team Building',
            description: 'Strengthen your herd with our farm-tastic team-building activities. Perfect for corporate groups and organizations.',
            icon: '/assets/img/icon/service6-icon(3).svg',
            number: '03'
        },
        {
            title: 'Farm Tours',
            description: 'Explore our organic farm and learn about sustainable farming practices. See our animals, crops, and facilities up close.',
            icon: '/assets/img/icon/service-inr-icon1.svg',
            number: '04'
        },
        {
            title: 'Animal Interaction',
            description: 'Get hands-on experience with our farm animals. Feed goats, collect eggs, and learn about animal care.',
            icon: '/assets/img/icon/service-inr-icon2.svg',
            number: '05'
        },
        {
            title: 'Harvest Activities',
            description: 'Participate in seasonal harvest activities. Pick fruits, dig up vegetables, and experience the joy of farming.',
                        ...
                        <div className="col-xl-6">
                            <div className="inner-hero-info">
                                ...
                                <ul>
                                    ...
                                    <li><Link className="aboutus_titlefix" href="/activities">Our Activities</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="col-xl-4 col-lg-6" key={index}>
                                <div className="service6-box margin-b30">
                                    <div className="service6-logos">
                                        <h3 className="title"><Link href="/activities">{activity.title}</Link></h3>
                                        <div className="inons">
                                            <img src={activity.icon} alt="" />
                                        </div>
                                    </div>
                                    <div className="space24"></div>
                                    <p className="pera-text">{activity.description}</p>
                                    <div className="space28"></div>
                                    <div className="service6-box-bottom">
                                        <Link href="/contact" className="btn3-home6">Learn More</Link>
                                        <div className="step-number">{activity.number}</div>
                                    </div>
                                </div>
                            </div>
                        ))}
