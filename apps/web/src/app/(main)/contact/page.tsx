                        ...
                        <div className="col-xl-6 col-lg-6">
                            <div className="contact2-form-area">
                                ...
                                <p className="pera_text">
                                    ...
                                    within 24 hours. Whether you are a customer,
                                    a partner, or a fellow nature lover, feel
                                    free to reach out. Our team is always here
                                    to help.
                                </p>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="contact2-form-bottom">
                                        <h3>
                                            <img
                                                src="/assets/img/icon/tick-hm2.svg"
                                                alt=""
                                            />
                            ...
                            <div className="vl-contact2-info">
                                <div className="contact2-info-mobile contact-inr-fix">
                                    ...
                                    <div className="contact-box-inr-shape">
                                        <img
                                            src="/assets/img/contact/contact-box-inr-shape.png"
                                            alt=""
                                        />
                                    </div>
                                </div>
                                <div className="vl-contact2-banner mt-30">
                                    <img
                                        src="/assets/img/contact/contact2-thumb.png"
                                        alt=""
                                    />
                                </div>
                            </div>
