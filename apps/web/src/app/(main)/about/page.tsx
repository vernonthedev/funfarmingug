                        ...
                        <div className="col-xl-8">
                            <div className="vl-about-inner-info">
                                <div className="vl-about-inner-heading">
                                    ...
                                    <div className="space16"></div>
                                    <p>
                                        Fun Farming Uganda is a unique
                                        agro-tourism destination where
                                        agriculture meets adventure. Located in
                                        the heart of Nakaseke District,
                                        Butalangu province, we offer an
                                        unforgettable farm experience that
                                        combines education, team building, and
                                        the beauty of Ugandan rural life.
                                    </p>
                                    <div className="space16"></div>
                                    <p>
                                        ...
                                        connection and joy. Our farm is a living
                                        classroom where visitors can learn about
                                        sustainable farming practices, interact
                                        with farm animals, and enjoy the
                            ...
                            <div className="vl-about-inner-content">
                                ...
                                <div className="vl-about-inner-items-info">
                                    <div className="vl-about-inner-items-content">
                                        <div className="logos">
                                            <img
                                                src="/assets/img/icon/about6-icon(1).svg"
                                                alt=""
                                            />
                                        </div>
                                    ...
                                    <div className="vl-about-inner-items-content">
                                        <div className="logos">
                                            <img
                                                src="/assets/img/icon/about6-icon(2).svg"
                                                alt=""
                                            />
                                        </div>
                                        <div className="text_content">
                                    ...
                                    <div className="vl-about-inner-items-list">
                                        <ul>
                                            <li>
                                                <img
                                                    src="/assets/img/icon/tick-about-inr.svg"
                                                    alt=""
                                                />
                ...
                <div className="container">
                            ...
                            <div className="service6-top">
                                ...
                                <div className="service6-top-right">
                                    <p
                                        ...
                                        data-aos-duration="1000"
                                    >
                                        Fun Farming Uganda began with a simple
                                        idea: to bring agriculture back to where
                                        people live. What started as a passion
                                        project on a small farm has grown into a
                                        thriving agro-tourism destination.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="vl-history-inr-gwrap">
                        <div className="vl-history-inr-gwrap-box">
                            ...
                            <div className="space16"></div>
                            <p>
                                One seed. One idea. One intention to grow
                                better. That is all it took to start what would
                                become a growing movement in sustainable
                        ...
                        <div className="vl-history-inr-gwrap-box">
                            ...
                            <div className="space16"></div>
                            <p>
                                With every seed we planted, a story began one of
                                hope, community, and conscious living. Our
                                journey has been marked by growth and learning.
                            </p>
                        </div>
                        <div className="vl-history-inr-gwrap-box">
                            <h2>2024</h2>
                            ...
                            <div className="space16"></div>
                            <p>
                                It all started with a farm and a dream to make
                                agriculture accessible to everyone. From that
                                humble beginning, we have grown into a leading
