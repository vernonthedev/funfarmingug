                        ...
                        <div className="col-xl-6">
                            <div className="inner-hero-info">
                                ...
                                <ul>
                                    ...
                                    <li><Link className="aboutus_titlefix" href="/shop">Farm Shop</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-xl-8 mx-auto text-center">
                            <div className="shop-inr-heading">
                                ...
                                <div className="space16"></div>
                                <p className="pera-text" data-aos="fade-left" data-aos-duration="1100">
                                    We are currently working on our online shop where you will be able to purchase fresh organic produce,
                                    farm products, and unique souvenirs from Fun Farming Uganda. Stay tuned for updates!
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="shop-inr-box" data-aos="zoom-out" data-aos-duration="900">
                                <div className="shop-inr-icon">
                                    <img src="/assets/img/icon/service6-icon(1).svg" alt="" />
                                </div>
                                <div className="space24"></div>
                                <h3><Link href="/contact">Fresh Produce</Link></h3>
                                <div className="space16"></div>
                                <p>Organic fruits, vegetables, and herbs grown on our farm</p>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="shop-inr-box" data-aos="zoom-out" data-aos-duration="1000">
                                <div className="shop-inr-icon">
                                    <img src="/assets/img/icon/service6-icon(2).svg" alt="" />
                                </div>
                                <div className="space24"></div>
                                <h3><Link href="/contact">Farm Products</Link></h3>
                                <div className="space16"></div>
                                <p>Eggs, honey, dairy, and other farm-fresh products</p>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="shop-inr-box" data-aos="zoom-out" data-aos-duration="1100">
                                <div className="shop-inr-icon">
                                    <img src="/assets/img/icon/service6-icon(3).svg" alt="" />
                                </div>
                                <div className="space24"></div>
                                <h3><Link href="/contact">Souvenirs</Link></h3>
                                <div className="space16"></div>
                                <p>Handcrafted items and memorabilia from your farm visit</p>
                            </div>
                        </div>
                    </div>
                </div>
