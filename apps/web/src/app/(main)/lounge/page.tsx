...
export default function LoungePage() {
    const loungeFeatures = [
        ...
        },
        {
            ...
            description:
                'Enjoy fresh juices, coffee, tea, and light snacks prepared with farm-fresh ingredients.',
        ...
        },
        {
            title: 'WiFi Access',
            description:
                'Stay connected with free WiFi access in our lounge area. Perfect for remote work or sharing your farm experience.',
        ...
        },
        {
            ...
            description:
                'Unwind in our peaceful lounge with soothing music and a cozy ambiance after your farm activities.',
        ...
        },
        {
            ...
            description:
                'Our lounge is perfect for group gatherings, team debriefings, or casual meetings in a relaxed setting.',
        ...
        },
        {
            title: 'Farm Views',
            description:
                'Enjoy stunning views of our organic farm while relaxing in the comfort of our lounge area.',
                            ...
                            <div className="cta4-area-content">
                                <div className="product4-heading">
                                    ...
                                    <h2
                                        ...
                                        data-aos-duration="1000"
                                    >
                                        Experience Comfort in the Heart of
                                        Nature
                                    </h2>
                                </div>
