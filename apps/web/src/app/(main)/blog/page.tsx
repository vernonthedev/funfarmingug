    ...
    const blogPosts = [
        {
            ...
            excerpt: 'At Fun Farming Uganda, we don t just grow plants — we cultivate ideas. Our blog is your go-to space for farming tips, stories, and insights.',
        ...
        },
        {
            ...
            excerpt: 'Dive into the Fun Farming Uganda blog, where every post is a seed of knowledge waiting to grow.',
                        ...
                        <div className="col-xl-6">
                            <div className="inner-hero-info">
                                ...
                                <ul>
                                    ...
                                    <li><Link className="aboutus_titlefix" href="/blog">Our Blog</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="about-inr-vlog-box margin-b30">
                                    ...
                                    <div className="about-inr-vlog-content">
                                        <div className="about-inr-vlog-meta">
                                            <ul>
                                                <li><Link href="/blog"><img src="/assets/img/icon/about-inr-vlog-user.svg" alt="" />{post.author}</Link></li>
                                                <li><Link href="/blog"><img src="/assets/img/icon/about-inr-vlog-cmnt.svg" alt="" />{post.comments} Comment</Link></li>
                                            </ul>
                                        </div>
                                        <div className="space16"></div>
