                    ...
                    <div className="row">
                        <div className="col-xl-8 mx-auto">
                            <div className="blog-details-inr-content">
                                <div
                                    className="blog-details-inr-meta"
                                    data-aos="fade-right"
                                ...
                                <div className="space24"></div>
                                <div
                                    className="blog-details-inr-thumb image-anime"
                                    data-aos="zoom-out"
                                ...
                                <div
                                    className="blog-details-inr-text"
                                    data-aos="fade-left"
                                ...
                                <div className="space32"></div>
                                <div
                                    className="blog-details-inr-btn"
                                    data-aos="fade-left"
