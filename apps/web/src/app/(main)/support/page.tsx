                        ...
                        <div className="col-xl-6">
                            <div className="inner-hero-info">
                                ...
                                <ul>
                                    ...
                                    <li><Link className="aboutus_titlefix" href="/support">Support</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        <div className="col-xl-8 mx-auto">
                            <div className="support-inr-content">
                                ...
                                <div className="space24"></div>
                                <div className="support-text" data-aos="fade-left" data-aos-duration="1100">
                                    <p>
                                        Thank you for visiting Fun Farming Uganda. We are here to provide you with the best possible experience
                                        and support for all your farming and agro-tourism needs.
                                    </p>
                                    <div className="space16"></div>
                                    <p>
                                        Whether you have questions about our services, need help with your booking, or want to learn more about
                                        our farm activities, our dedicated support team is ready to assist you.
                                    </p>
                                    <div className="space16"></div>
                                    <p>
                                    ...
                                    <ul className="support-list">
                                        <li><strong>Email:</strong> info@funfarminguganda.com</li>
                                        <li><strong>Phone:</strong> +256 700 000 000</li>
                                        <li><strong>Visit Us:</strong> Butalangu, Nakaseke District, Uganda</li>
                                        <li><strong>Business Hours:</strong> Monday - Friday: 8:00 AM - 6:00 PM</li>
                                    </ul>
                                </div>
                                <div className="space32"></div>
                                <div className="support-more" data-aos="fade-left" data-aos-duration="1200">
