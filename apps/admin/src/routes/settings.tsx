...
import { Bell, CreditCard, Key, LogOut, MessageSquare, Settings } from "lucide-react";
      ...
      <div className="rounded-2xl border bg-card not-dark:bg-clip-padding text-card-foreground shadow-xs/5">
        <div className="grid lg:grid-cols-12">
          ...
          <div className="lg:col-span-3 border-e p-4">
            <p className="text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-3">Business settings</p>
            <nav className="flex flex-col gap-1">
              {[
                ...
                { icon: MessageSquare, label: "Billing & Invoices" },
              ].map((item) => {
            ...
            <div className="p-6 space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <div
                        ...
                        style={{
                          backgroundImage: "url(https://ui-avatars.com/api/?name=Restaurant+Owner&background=0054a6&color=fff&size=128)",
                        }}
                      />
                      <div className="flex gap-2">
                        <Button size="sm">Change avatar</Button>
                        <Button variant="ghost" size="sm" className="text-destructive hover:text-destructive">Delete avatar</Button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <Input className="max-w-xs" defaultValue="hello@servabistro.com" />
              ...
              <div>
                ...
                <Button variant="outline" size="sm">Set new password</Button>
              </div>
              ...
              {/* Public profile */}
              <div>
                <h3 className="text-sm font-medium mb-1">Public profile</h3>
                <p className="text-xs text-muted-foreground mb-3">
                  Making your profile public means that anyone on the Serva network will be able to find you.
                </p>
                <Label className="flex items-center gap-3 cursor-pointer">
                  <Checkbox defaultChecked id="public-profile" />
                  <span className="text-sm font-medium">You're currently visible</span>
                </Label>
              </div>
            </div>
