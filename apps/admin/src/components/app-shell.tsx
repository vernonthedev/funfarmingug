...
const mainNav: ReadonlyArray<NavItem> = [
  ...
  { label: "POS", icon: ShoppingBag, to: "/pos" },
        ...
        <CommandDialogPopup>
          ...
          >
            ...
            <CommandPanel>
              ...
              <CommandList>
                {(group: { value: string; items: { label: string; value: string }[] }) => (
      ...
      <MenuPrimitive>
        ...
        <MenuPopup align="start" side="bottom">
          <div className="px-2 py-1.5">
            ...
            <p className="text-xs text-muted-foreground">owner@servabistro.com</p>
          </div>
          <MenuSeparator />
      ...
      <SidebarContent>
        ...
        <SidebarGroup className="mt-auto">
          <SidebarGroupContent>
            <SidebarMenu className="gap-0.5">
              <SidebarMenuItem>
                <SidebarMenuButton render={<Link to="/settings" />} tooltip="Help & Support">
                  <LifeBuoy />
                  <span className="max-lg:sr-only">Help & Support</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
          </SidebarGroupContent>
