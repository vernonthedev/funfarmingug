                ...
                <div className="o-block">
                            ...
                            <div className="o-vt__main o-vt__main--reversed">
                                ...
                                <div className="o-vt__content s-text">
                                    ...
                                    <p>
                                        ...
                                        country air are guaranteed to make you
                                        hungry.&nbsp;
                                        <br />
                                        <br />
                    ...
                    <div className="o-food-assortment">
                        <div className="l-contain l-contain--wide">
                            <h2 className="o-food-assortment__title">
                                Some Of Our Breeds
                            </h2>
                            <div className="o-food-assortment__wrapper">
                                <a
                                    href="#11"
                                    className="o-food-assortment__item"
                                >
                                    <img
                                        src="/img/gallery/funfarm_n1.png"
                                        alt="Goat Breeds at fun farming uganda"
                                    />
                                    Goat Breed
                                </a>
                                <a
                                ...
                                >
                                    <img
                                        ...
                                        alt="Goat Breed at fun farming uganda"
                                    />
                                    Goat Breed
                                </a>
                                <a
                                ...
                                >
                                    <img
                                        ...
                                        alt="Another Goat Breed At Fun Farming Uganda"
                                    />
                                    Goat Breed
                                </a>
                                <a
                                ...
                                >
                                    <img
                                        ...
                                        alt="Goat On Fun farming Uganda"
                                    />
                                    Goat Breed
                                </a>
                                <a
                    ...
                    <div
                        id="component-item-5"
                        data-type="farmfoodProduct"
                        className="u-mb-neg-slant-height u-slant-top"
                    >
                        <div className="o-component-area__component l-contain l-contain--wide">
                            <div
                                className="l-double l-double--wide l-double--reversed u-spacing-pt6"
                                id="12"
                            >
                                ...
                                <div
                                    className="l-double__right s-text s-ol-list"
                                    data-kal="slide-up"
                                >
                                    <h2>BBQ + Drinks</h2>
                                    <p>
                                    ...
                                    <p>
                                        The ideal conclusion to your
                                        team-building? A delicious BBQ.
                                        You&apos;ll enjoy a delightful buffet
                                        with around ten dishes &ndash; including
                                        vegetables, pastas, potato salad, bread,
                                        and sauces &ndash; and choose from eight
                                        types of meat that our BBQ specialist
                                        will grill for you.
                                    </p>
                                    <p>
                                        All you have to do is sit back,
                                        occasionally visit our baker and the
                                        buffet for a fresh serving. Enjoy!{' '}
                                        <strong>
                                            You can reserve a barbecue for your
                                            team online after adding an activity
                                            to your schedule.
                                        </strong>
                                    </p>
                                    <ul>
