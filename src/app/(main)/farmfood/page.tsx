                        ...
                        <div className="col-lg-6">
                            <div className="about-one__content">
                                ...
                                <p className="about-one__content__text">
                                    Complete your day with a light lunch or extensive meal from our in-house caterer.
                                    Crazy activities in the country air are guaranteed to make you hungry.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-xl-12 text-center">
                        <p className="about-one__content__text"><strong>Make your bookings today!</strong></p>
                    </div>
                </div>
            </div>
        </>
