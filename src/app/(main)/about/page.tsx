    ...
    return (
        <>
            <div className="l-main">
                <div className="o-imagebanner o-imagebanner--medium u-mb-neg-slant-height"></div>

                <h1 hidden>Who are we</h1>

                <div className="o-component-area u-mb-neg-slant-height u-slant-top u-bg-neutral--0">
                    <div
                        id="component-item-1"
                        data-type="videoText"
                                ...
                                <div className="o-vt__video">
                                    <div className="c-video">
                                        <img
                                            ...
                                            src="/img/logo.png"
                                            alt="FunFarming Uganda Logo"
                                            width="70%"
                                        />
                                    </div>
                                </div>
                                <div className="o-vt__content s-text">
                                    <h2>What is Fun Farming Uganda?</h2>
                                    <p>
                                        "Fun farming Uganda is an organic farm
                                        engaging in diverse agricultural
                                        activities like goat breeding, poultry
                                        farming, banana plantation also serves
                                        as a youth agro project educating and
                                        involving young individuals in
                                        sustainable farming practices,
                                        contributing to Uganda&apos;s
                                        agricultural sector"
                                    </p>
                                    <Link
                            ...
                            <div className="o-component-area__component l-contain">
                                <div className="o-streamer">
                                    ...
                                    <h2 className="o-streamer__text">
                                        Farmtastic activities for a stronger
                                        herd feeling
                                    </h2>
                                </div>
                            </div>
                                ...
                                <div className="l-double l-double--wide u-spacing-pt6">
                                    <div className="l-double__left">
                                        <img
                                            ...
                                            src="/img/gallery/funfarm_n28.png"
                                            alt="Goats image at fun farming Uganda"
                                    ...
                                    <div
                                        ...
                                        data-kal="slide-up"
                                    >
                                        <h2>Good meat in the tub</h2>
                                        <p>
                                            The cart at our Fun Farming location
                                            is pulled by a farmtastic and
                                            farmbitious farmer and farmer&apos;s
                                            wife. In other words: our Chief
                                            Executive Farmers (CEF). With them
                                            we all have good meat in the tank.
                                            They are farm ambassadors who are
                                            particularly keen to provide people
                                            with a positive experience of their
                                            milk. In the open fields, between
                                            the cows or deep in the straw.
                                            Together with their farmtastic herd
                                            of game supervisors, they have only
                                            one goal in mind: strengthening the
                                            herd and organic spirit as well as
                                            embracing the agro tourism concept
                                            in Uganda.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="o-component-area__component l-contain l-contain--wide">
                                <div className="l-double l-double--wide l-double--reversed u-spacing-pt6">
                                    ...
                                    >
                                        ...
                                        <p>
                                            These are the three key words at Fun
                                            Farming Uganda. With the Farm Games
                                            and Farm Expert Games, herds of cow
                                            colleagues or friends are presented
                                            with a fun mix of thinking and doing
                                            to strengthen team spirit. A cow and
                                            goat-lover or quiet in nature. A
                                            young foal or an old hand in the
                                            trade. Each of our games is made
                                            with the idea that everyone will
                                            remember this team event for a long
                                            time.
                                        </p>
                                        <Link
                                            className="c-button c-button--big"
