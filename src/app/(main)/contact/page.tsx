...
export default function ContactPage() {
    const [formData, setFormData] = useState({ name: '', email: '', phone: '', message: '', subscribe: false });
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setTimeout(() => { setIsSubmitting(false); setSubmitSuccess(true); setFormData({ name: '', email: '', phone: '', message: '', subscribe: false }); }, 1500);
    };
    ...
    return (
        <>
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <p>Thank you for your message! We will get back to you soon. Welcome to the herd!</p>
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="garlon-btn" onClick={() => setSubmitSuccess(false)}>
                                    <span>Got it</span>
                                </button>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="row gutter-y-30">
                        <div className="col-lg-6">
                            <img src="/webimgs/david-holding-goat.jpg" alt="Fun Farming Uganda" style={{ width: '100%', borderRadius: '12px' }} />
                        </div>
                        <div className="col-lg-6">
                            <div className="contact-one__content">
                                <div className="contact-one__info">
                                    <h3>Get in Touch</h3>
                                    <p>Would you like more information about our activities or approach? Take the bull by the horns — give us a call, send an email, or check our FAQ.</p>
                                </div>
                                <div className="contact-one__details">
                                    <div className="contact-one__item">
                                        ...
                                        <div className="contact-one__text"><h4>Phone</h4><p><a href="tel:+256772826680">+256 772 826 680</a></p></div>
                                    </div>
                                    <div className="contact-one__item">
                                        <div className="contact-one__icon">
                                        ...
                                        <div className="contact-one__text"><h4>Email</h4><p><a href="mailto:info@funfarminguganda.com">info@funfarminguganda.com</a></p></div>
                                    </div>
                                    <div className="contact-one__item">
                                        <div className="contact-one__icon">
                                        ...
                                        <div className="contact-one__text"><h4>Address</h4><p>Nakaseke District, Butalangu Province, Uganda</p></div>
                                    </div>
                                </div>
                                <div className="contact-one__social">
                                    <h4>Follow Us</h4>
                                    <div className="contact-one__social-links">
                                        <a href="https://www.linkedin.com/company/funfarming/" target="_blank" rel="noopener noreferrer" className="contact-one__social-link" title="LinkedIn"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2zM4 6a2 2 0 100-4 2 2 0 000 4z" /></svg></a>
                                        <a href="https://www.facebook.com/funfarming" target="_blank" rel="noopener noreferrer" className="contact-one__social-link" title="Facebook"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" /></svg></a>
                                        <a href="https://www.instagram.com/funfarming/" target="_blank" rel="noopener noreferrer" className="contact-one__social-link" title="Instagram"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><rect x="2" y="2" width="20" height="20" rx="5" /><circle cx="12" cy="12" r="5" /><circle cx="17.5" cy="6.5" r="1.5" fill="white" /></svg></a>
                                        <a href="https://www.youtube.com/channel/#" target="_blank" rel="noopener noreferrer" className="contact-one__social-link" title="YouTube"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M22.54 6.42a2.78 2.78 0 00-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 00-1.94 2A29 29 0 001 11.75a29 29 0 00.46 5.33A2.78 2.78 0 003.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 001.94-2 29 29 0 00.46-5.25 29 29 0 00-.46-5.33z" /><polygon points="9.75 15.02 15.5 11.75 9.75 8.48" fill="white" /></svg></a>
                                        <a href="https://www.tiktok.com/@funfarming" target="_blank" rel="noopener noreferrer" className="contact-one__social-link" title="TikTok"><svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M9 12a4 4 0 100 8 4 4 0 000-8zm0 0V4h6v4a4 4 0 004 4V8a4 4 0 00-4-4H9z" /></svg></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="faq-one__title"><h2>Frequently Asked Questions</h2></div>
                            <ul className="garlon-accrodion list-unstyled">
                                {faqs.map((faq, index) => (
                                    <li key={index} className={`garlon-accrodion__item ${openFaq === index ? 'active' : ''}`}>
                                        <div className="garlon-accrodion__title" onClick={() => toggleFaq(index)}>
                                            <h3>{faq.question}</h3>
                                            <div className="garlon-accrodion__icon"><span className="icon-plus"></span><span className="icon-minus"></span></div>
                                        </div>
                                        <div className="garlon-accrodion__content" style={{ display: openFaq === index ? 'block' : 'none' }}>
                                            <p>{faq.answer}</p>
                                        </div>
                                    </li>
                                ))}
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            <div className="contact-form__inner">
                                <div className="contact-form__title"><h2>Send Us a Message</h2><p>Have a question that is not listed above? We are happy to answer it.</p></div>
                                <form onSubmit={handleSubmit} noValidate>
                                    <div className="row">
                                        ...
                                        <div className="col-md-6">
                                            <div className="contact-form__input-box">
                                                <input type="email" id="email" name="email" placeholder="Your Email" value={formData.email} onChange={handleChange} onBlur={(e) => { if (e.target.value && !validateEmail(e.target.value)) setErrors((prev) => ({ ...prev, email: 'Invalid email address' })); else setErrors((prev) => ({ ...prev, email: '' })); }} />
                                        ...
                                        <div className="col-md-12">
                                            <div className="contact-form__input-box">
                                                <label className="contact-form__checkbox">
                                                    ...
                                                    <span>Yes, keep me informed of farm news. I can unsubscribe anytime.</span>
                                                </label>
                                            </div>
                                        </div>
                                        <div className="col-md-12">
                                            <button type="submit" className="garlon-btn" disabled={isSubmitting}>
                                                <span>{isSubmitting ? 'Sending...' : 'Send Message'}</span>
                                                <i><svg width="7" height="10"><use href="/img/icon-arrowRight.svg#arrowRight"></use></svg></i>
                                            </button>
                                        </div>
                                    </div>
                                </form>
            ...
            <section className="contact-map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15957.569204460351!2d32.2763608!3d0.837297!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x177c89c49c245505%3A0xb0d8551936f00965!2sFun%20Farming%20Uganda!5e0!3m2!1sen!2sug!4v1698927724672!5m2!1sen!2sug" width="100%" height="450" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Fun Farming Uganda Location"></iframe>
            </section>

            <CtaSection icon="icon-leaf" title="Ready to Get in Touch?" text="Fill out the form or give us a call. We look forward to hearing from you!" buttonLabel="Contact Us" buttonHref="/contact" />
        </>
    );
}