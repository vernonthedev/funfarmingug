      ...
      <section className="references-section section-space">
        <div className="container">
          <div className="section-title section-title__center">
            ...
            <h2 className="section-title__title">What Our Guests Say About Us</h2>
          </div>

          <div className="references-grid">
            {testimonials.map((testimonial) => (
              <article key={testimonial.id} className="reference-card">
                <div className="reference-card__header">
                  <img src={testimonial.avatar} alt={testimonial.author} className="reference-card__avatar" />
                  <div className="reference-card__author">
                    <h4 className="reference-card__name">{testimonial.author}</h4>
                    <p className="reference-card__role">{testimonial.role}</p>
                  </div>
                </div>
                <div className="reference-card__rating">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <svg key={i} width="18" height="18" viewBox="0 0 24 24" fill="#fbbf24" className="star-icon">
                ...
                <p className="reference-card__text">"{testimonial.text}"</p>
          ...
          <div className="cta-section" style={{ textAlign: 'center', marginTop: '60px' }}>
            <h3>Ready to Create Your Own Experience?</h3>
            <p className="u-spacing-mt2">Join hundreds of satisfied guests who\'ve discovered the magic of Fun Farming Uganda.</p>
            <div className="u-spacing-mt4">
              <Link href="/contact" className="garlon-btn garlon-btn--large">
